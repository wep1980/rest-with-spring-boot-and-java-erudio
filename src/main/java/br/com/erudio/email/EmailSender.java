...
/**
 * Padrao de projeto fluente interface
 * Os metodos retornam uma instancia de emailSandler com a nova propriedade atribuida
 */
@Component
public class EmailSender implements Serializable {
    ...
    private final JavaMailSender mailSender; // final -> garante que a sua referencia nao seja alterada apos sua inicializacao
    private String to;
    ...
    public EmailSender to(String to) {
        ...
        return this; // retorna uma instancia desse objeto com a propriedade setada
    }
